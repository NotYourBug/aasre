...
FEISHU_ACK_RETENTION_SECONDS = 14 * 24 * 60 * 60
FEISHU_ACK_QUEUE_LIMIT = 64
FEISHU_ACK_LEDGER_COMPACT_EVERY = 1024
FEISHU_LEDGER_LOCK_TIMEOUT_SECONDS = 0.5
FEISHU_ACK_LEDGER_FILENAME = "feishu_ack_lifecycle.jsonl"
FEISHU_FEEDBACK_AUTHORITY_FILENAME = "feishu_feedback_authority.jsonl"
FEISHU_FEEDBACK_FILENAME = "feishu_feedback.jsonl"
FEISHU_ACK_RECOVERY_SECONDS = 5.0
FEISHU_INTERACTION_HTTP_TIMEOUT_SECONDS = 2.0
FEISHU_ACK_RECOVERY_RECORD_LIMIT = 64
FEISHU_PROCESSING_EMOJI = "EYE"
