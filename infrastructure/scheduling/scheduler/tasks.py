...
def _investigation_report(result: dict[str, object] | None) -> str:
    """Select canonical Markdown while retaining legacy-runner compatibility."""
    if not result:
        return ""
...
def _build_daily_summary(task: ScheduledTask, runners: SchedulerRunners) -> str:
    ...
    try:
        ...
        if report := _investigation_report(result):
            return report
    ...
    return (
        ...
        f"_Generated by OpenSRE scheduled delivery_"
    )
